      ...
      <div className="Navbar">
        <div
          className={`icon icon-1 ${
            this.state.currentIcon === "icon-1" ? "iconSelected" : "notSelected"
          }`}
          onClick={() => {
        ...
        <div
          className={`icon icon-2 ${
            this.state.currentIcon === "icon-2" ? "iconSelected" : "notSelected"
          }`}
          onClick={() => {
        ...
        <div
          className={`icon icon-3 ${
            this.state.currentIcon === "icon-3" ? "iconSelected" : "notSelected"
          }`}
          onClick={() => {
        ...
        <div
          className={`icon icon-4 ${
            this.state.currentIcon === "icon-4" ? "iconSelected" : "notSelected"
          }`}
          onClick={() => {
